...
# Zdefiniować klasę Rectangle wraz z potrzebnymi metodami. 
# Prostokąt jest określony przez podanie dwóch wierzchołków, 
# lewego dolnego i prawego górnego. Napisać kod testujący moduł rectangles.

import math as M
from cw6_Point import Point
class Rectangle:
...
class TestRectangle(unittest.TestCase):
    def setUp(self):
        self.r1 = Rectangle(2., 5., 1., 1.)
        self.r2 = Rectangle(1., 3., 5., 8.)
        self.r3 = Rectangle(2., 5., 1., 1.)

    def test_print(self):
        self.assertEqual(str(self.r1), "[(2.0, 5.0), (1.0, 1.0)]")
        self.assertEqual(repr(self.r1), "Rectangle[(2.0, 5.0), (1.0, 1.0)]")
    ...
    def test_center(self):
        self.assertEqual(str(self.r1.center()), '(1.5, 3.0)')

    def test_area(self):
        self.assertEqual(self.r1.area(), 4)

    def test_move(self):
        self.assertEqual(str(self.r1.move(1, 1)), '[(3.0, 6.0), (2.0, 2.0)]')
